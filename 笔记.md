...
BeginPos = Origin + AxisDirs * Extent;
EndPos = Origin + AxisDirs * HitResultTraceDistance;

FCollisionQueryParams Param;
Param.bTraceAsyncScene = true;
Param.bTraceComplex = true;
Param.AddIgnoredActor(this);
Param.AddIgnoredActor(UGameplayStatics::GetPlayerCharacter(this, 0));

TArray<AActor*> AttachedActors;
GetAttachedActors(AttachedActors);
Param.AddIgnoredActors(AttachedActors);

if (!GetWorld()->LineTraceSingleByChannel(HitResult, BeginPos, EndPos, ECC_EngineTraceChannel6, Param))
	return;

FVector NewLocation = GetActorLocation() + FVector::Dist(BeginPos, HitResult.Location) * AxisDirs;
...
## 获得FSceneViewport
```
FSceneViewport* Viewport = GetGameInstance()->GetGameViewportClient()->GetGameViewport();
```
