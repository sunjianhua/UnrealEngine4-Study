...
根据公司的招聘条件，技术方面能够胜任。游戏制作经验上：有多年的游戏开发经历，做过的游戏类型比较广，PC上网络游戏做过4款，类型涵盖2D/3D MMORPG、休闲游戏、棋牌游戏。街机游戏做过一款，类型为3D第一人称射击。手游做过3款，类型为策略类游戏和棋牌游戏。VR项目做过一款，类型为飞行模拟。【下面表格有列】

简单罗列一下竞争点：

1. 参与的游戏项目多，类型广，多年的经验积累对参与新项目做开发，熟门熟路。
2. 以往项目担任过程序、主程或产品经理的角色，多年的经验积累对负责的模块，能做到符合软件开发的工程性要求，减少因工程性混乱给公司造成的损失。
3. 以往多个项目经验的积累，熟悉项目开发后期或上线后，都要做那些工作，那些要前期就要规划和实施，减少项目后期的返工和推倒重来，减少公司损失。
4. 以往参与的项目类型广，如果公司需要拓展游戏类型，能够根据以往的经验迅速为公司提供支持。
5. 做事积极主动，有条理，以往项目中除了编码工作外，还做过多个项目的需求、分析、规划、执行。
6. 做游戏兴趣远大于玩游戏的兴趣，有强力的内在驱动去做一款好玩的游戏。
