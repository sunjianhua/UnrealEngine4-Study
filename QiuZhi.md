...
建议用Adobe Acrobat Reader打开这个PDF,因为有的PDF阅读器不支持网址链接的点击。
<br>
...
根据公司的招聘条件，技术方面能够胜任，有多个同类商业项目的开发经验，有些项目担任主程序职责，有很强的快速定位问题和独立解决问题能力。

简单罗列一下竞争点：

1. 参与过多个完整的UE4商业项目，在一些项目里担任主程序，主要用UE4的c++模式开发家装软件，用蓝图做过多个用触摸屏操作的房展项目，参与过一个飞机内部互动的VR项目，独立解决问题的能力强。
2. 负责过一个街机游戏研发，类型为第一人称3D射击游戏，有公司自己研发的头盔和外设枪。
3. 以往项目担任过程序、主程或产品经理的角色，多年的经验积累对负责的模块，能做到符合软件开发的工程性要求，减少因工程性混乱给公司造成的损失。
4. 以往多个项目经验的积累，熟悉项目开发后期或上线后，都要做那些工作，那些要前期就要规划和实施，减少项目后期的返工和推倒重来，减少公司损失。
5. 以往参与的项目类型广，如果公司需要拓展产品类型，能够根据以往的经验为公司提供支持。
6. 做事积极主动，有条理，以往项目中除了编码工作外，还做过多个项目的需求、分析、规划、执行。
...
## <a name="2">成长经历【倒序】</a>
1. 2016.9 ～ 至今 基于UE4进行项目开发，开发了多个完整上线的项目，一：<a href="http://vidahouse.com/product">vidahouse</a>（<a href="https://v.qq.com/x/page/e0362wl7bwa.html">演示</a>）【VR室内设计软件、业务逻辑程序、UE4 + VXG、c++】。二：触屏全景交互展示（<a href="http://v.youku.com/v_show/id_XMzEwMjIzMTUxMg==.html?spm=a2hzp.8244740.0.0">演示1</a>，<a href="http://v.youku.com/v_show/id_XMzEwMjIyNTM1Ng==.html?spm=a2hzp.8244740.0.0">演示2</a>）【主程序、UE4、蓝图 + c++ + Python】。三：商用飞机展示【初期的设计、规划、任务分配 + 地形绘制，UE4 + World Machine + UE4-OceanProject，蓝图 + c++，一个VR项目，在初期设计时，就围绕VR的特性进行设计，比如全3D UI，移动、交互等】

2. 2015～2016 开发了三款手游，一：<a href="http://v.youku.com/v_show/id_XMTQwODk0MTIwMA==.html?spm=a2hzp.8253869.0.0">血战宣城【手游】</a>【客户端主程序、cocos2d-x、c++】。2：<a href="http://newgame.17173.com/game-review-4047573.html">魂器学院</a>【客户端程序、cocos2d-x、lua】。三：<a href="http://www.yxdown.com/mzt/evasgz/?baidutj">EVA适格者</a>【客户端程序 + 服务器程序、cocos2d-x + Spine + 物理模块、lua】。

3. 2013～2014 自己创业做手游开发。
4. 2011 ～2012 做应用分发平台。

5. 2009～2010 负责一个街机项目，游戏类型是第一人称3D射击游戏，用的是Torque3D引擎，这个也属于软件和硬件结合项目，硬件为公司自主研发的红外枪。这个项目是负责和主程，Torque3D是支持跨平台的，Windows平台是基于Directx封装，在开发过程中，在Torque3D引擎层面增加了下许多功能模块，其中一项就是把外设枪的信号处理库整合进引擎。

6. 2007～2009 主要做了两个网游项目，一：仿万智牌的网络卡牌游戏，参与的是客户端开发，用的是Hge/Ogre3d引擎，个人记得做过的一项改动两个引擎底层的工作是，把Hge的2d粒子系统，整合进Ogre3d。二：3D MMORPG，参与的客户端开发，基于Directx9封装，地图编辑器是基于MFC开发。

7. 2005～2007 在上海和北京参与了3个网游项目，一：回合制2D MMoRPG，客户端开发，客户端用的是自研引擎，基于DirectxDraw封装。二：成长类大厅休闲网游，客户端开发，客户端是自研引擎，基于Directx7封装。三：基于摄像头的休闲网游，这个也属于软硬结合项目，参与的是服务器开发，服务器基于微软完成端口封装，数据库MySql。

8. 2003～2004 在青岛一个大国企，做智能公交，参与的是智能报站和车载视频播放，这个属于软件和硬件结合项目，车载视频播放用的是WinCe平台，属于嵌入式开发，开发语言为C++。车载视频播放，播放娱乐节目会插入广告，个人独立做了一个视频编辑软件，用来编辑播放的节目内容。

## <a name="3">自我推荐</a>
1. 求职的职位是公司的UE4程序开发，参与过多个完整的UE4商业项目，在一些项目里担任主程序，主要用UE4的c++模式开发，独立解决问题的能力强。从2016年9月中旬开始用UE4引擎进行商业开发，虽然只有一年多时间，但开发了多个商业项目，这个在上面的【参与产品】部分有详细的列取，对UE4的C++模式或蓝图模式都有多个商业项目实现，实现的项目类型涵盖：VR模式的大场景飞机漫游和交互，VR室内设计软件，触屏全景交互展示，UE4相关的技术点都或多或少都有用到，基于UE4程序开发是能够胜任的。

2. 从参加工作一直从事软件开发，目前对软件项目的理解，就是【工程性】，软件虽然是一行行代码敲出来的，但是就软件开发而言，写代码反而不是第一重要的，重要的是对软件项目的整体把控和质量监督，比如软件的规划、设计、框架搭建、编码规范制定、项目进度的管理制度和人员协调、质检跟进，项目的不断迭代更新等这一套流程处理，这些处理好，编码确实只是码农做的活，就像盖楼房，有设计图纸和施工规范，施工工人要求就很低了。基于对软件开发有这样的认识，在工作中能做到负责的部分，尽量做到工程性要求，比如编码规范、Git管理代码、功能模块化处理、降低模块间的耦合性做到最大程度的复用、增加容错性处理和错误自反馈、代码易于阅读、模块易于扩展和维护、代码不断的重构和迭代、编写测试用例等，以上这些可以参考我的开源项目。因此参与商业化的软件开发应该能够胜任。
