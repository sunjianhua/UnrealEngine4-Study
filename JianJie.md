...
<br>
更好的排版格式看：<a href = "https://github.com/sunjianhua/UnrealEngine4-Study/blob/master/QiuZhi.md">https://github.com/sunjianhua/UnrealEngine4-Study/blob/master/QiuZhi.md</a>
...
根据公司的招聘条件，技术方面能够胜任。游戏制作经验上：有多年的游戏开发经历，做过的游戏类型比较广，PC上网络游戏做过5款，类型涵盖2D/3D MMORPG、休闲游戏、卡牌游戏、棋牌游戏。街机游戏做过一款，类型为3D第一人称射击。手游做过3款，类型为策略类游戏和棋牌游戏。VR项目做过一款，类型为飞行模拟。【下面表格有列】

简单罗列一下竞争点：

1. 参与过多个完整的UE4商业项目，在一些项目里担任主程序，主要用UE4的c++模式开发【用蓝图也做过商业项目】，独立解决问题的能力强。
2. 参与的游戏项目多，类型广，多年的经验积累对参与新项目做开发，熟门熟路。
...
5. 以往参与的项目类型广，如果公司需要拓展游戏类型，能够根据以往的经验迅速为公司提供支持。
6. 做事积极主动，有条理，以往项目中除了编码工作外，还做过多个项目的需求、分析、规划、执行。
7. 做游戏兴趣远大于玩游戏的兴趣，有强力的内在驱动去做一款好玩的游戏。
8. 以往项目中有做过服务器相关的工作，可以在服务器需要分担任务而人手短缺的情况下，做些服务器的工作。
